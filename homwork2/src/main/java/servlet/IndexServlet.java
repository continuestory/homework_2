...
//        // 数据处理
        ...
        double inputMin = maps[maps.length - 1].getValue(), inputMax = maps[0].getValue(), outputMin = 5, outputMax =200;
        int i = 0;
    ...
    public void init() throws ServletException {
        ...
        fileHandler = new FileHandleImpl();
    }
